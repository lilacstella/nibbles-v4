...
hand_font = ImageFont.truetype(str(media_dir.joinpath('fonts').joinpath('Kitnoms-Regular.ttf')), 50)
...
def generate_lb(ranks, names, pts):
    ...
    txt.text((45, 125), ranks, WHITE, font=hand_font, spacing=23)
    txt.text((90, 125), names, WHITE, font=hand_font, spacing=23)
    txt.text((350, 125), pts, WHITE, font=hand_font, spacing=23)
